...
/*                                                                      */
/************************************************************************/
  l1att->kisslink = open_win(l1att->device, l1att->speed);
...
/************************************************************************/
  ...
  {
    /* Handle schliessen. */
    CloseHandle((void *)l1att->kisslink);
    return(TRUE);
  }
        ...
        case ATT_DEVICE:
          ...
          switch(att_kisstype)
          {
            ...
            case KISS_TELNET:
              if (atoi(cBuf) < 65536)
                strncpy(att_device, cBuf, MAXPATH);
                /* TCP-Port liegt ausserhalb vom Grenzbereich. */
              else
                /* Markiere Fehlermeldung. */
                error = ATT_INV_TCP;
...
#ifdef SIXPACK
        case KISS_6PACK:
          /* 6PACK-Schnittstelle schliessen. */
          Sixpack_l1exit();
